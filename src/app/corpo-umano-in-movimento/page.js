...
export default function CorpoUmanoInMovimento() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header Section */}
      <div className="py-12 bg-gradient-to-r from-blue-500 to-teal-400">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="mb-8">
          <h2 className="text-3xl font-semibold text-gray-800 mb-4">Flessione della spalla</h2>
        ...
        {/* 3D Model Canvas */}
        <div className="w-full h-[500px] bg-gray-100 rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          <h3 className="text-xl font-medium text-gray-800 mb-2">Come interagire con il modello:</h3>
      ...
      <div className="container mx-auto px-4 py-12 bg-white">
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Biomeccanica della flessione</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Muscoli coinvolti</h2>
            <ul className="list-disc pl-6 text-gray-700">
